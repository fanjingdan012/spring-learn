...
public class ConferenceController implements BeanNameAware{//, BeanFactoryAware,{
	...
	public ConferenceController(){
		System.out.println("ConferenceController Constructor");
	}

	@Override
	public void setBeanName(String name) {
		System.out.println("ConferenceController BeanNameAware setBeanName:"+name);

	}

//	@Override
//	public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
//		System.out.println("ConferenceController ApplicationContextAware setApplicationContext:"+applicationContext);
//
//	}
//
//	@Override
//	public void setBeanFactory(BeanFactory beanFactory) throws BeansException {
//		System.out.println("ConferenceController BeanFactoryAware setBeanFactory:"+beanFactory);
//
//	}
